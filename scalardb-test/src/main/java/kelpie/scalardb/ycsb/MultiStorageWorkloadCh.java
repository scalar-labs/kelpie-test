...
import static kelpie.scalardb.ycsb.YcsbCommon.getHotspotRecordCount;
...
/** 
 * Multi-storage workload Ch:
 * Same number of read operations for both primary and secondary database.
 * For primary, there is a hotspot; only limited rage of records are accessed.
*/
public class MultiStorageWorkloadCh extends TimeBasedProcessor {
  ...
  public MultiStorageWorkloadCh(Config config) {
    super(config);
